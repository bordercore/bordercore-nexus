...
export const TodoEditor = forwardRef<TodoEditorHandle, TodoEditorProps>(function TodoEditor(
  { priorityList, editTodoUrl, createTodoUrl, tagSearchUrl, onAdd, onDelete, onEdit },
  ref
) {
  ...
  const openModal = useCallback((actionParam: "Edit" | "Create", todoInfoParam?: TodoInfo) => {
    flushSync(() => {
            ...
            <div>
              ...
              >
                <div>
                  ...
                  {/* Note field */}
                  <div className="row mb-3">
                    <label className="fw-bold col-lg-3 col-form-label text-end" htmlFor="id_note">
                      Note
                    </label>
                    <div
                  ...
                  {/* Tags field */}
                  <div className="row mb-3">
                    <label className="fw-bold col-lg-3 col-form-label text-end" htmlFor="inputTags">
                      Tags
                    </label>
                    <div className="col-lg-9">
                      <TagsInput
