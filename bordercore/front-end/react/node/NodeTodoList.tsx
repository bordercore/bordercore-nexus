        ...
        <li className="hover-target list-group-item pe-0" data-uuid={element.uuid}>
          <div className="dropdown-height d-flex align-items-start">
            ...
            <div>
              ...
              {element.note && <div className="node-object-note">{element.note}</div>}
            </div>
...
const NodeTodoList = forwardRef<NodeTodoListHandle, NodeTodoListProps>(function NodeTodoList(
  {
    nodeUuid,
    getTodoListUrl,
    addNodeTodoUrl,
  ...
  const handleTodoRemove = (todoUuid: string) => {
    const url = removeNodeTodoUrl.replace("00000000-0000-0000-0000-000000000000", todoUuid);
    doDelete(
      url,
      () => {
        getTodoList();
    ...
    <div className="hover-reveal-target">
      <Card cardClassName="backdrop-filter node-color-1 position-relative" titleSlot={titleSlot}>
        ...
        <DndContext sensors={sensors} collisionDetection={closestCenter} onDragEnd={handleDragEnd}>
          ...
          >
            <ul id="sort-container-tags" className="list-group list-group-flush interior-borders">
