...
export function DrillQuestionPage({
  ...
  useEffect(() => {
    ...
    const handleHotkey = (event: KeyboardEvent, handler: any) => {
      ...
      if ((event.target as HTMLElement)?.parentElement?.classList.contains("code-input")) {
        return;
      }
  ...
  const getSessionDescription = () => {
    ...
    switch (studySession.type) {
      ...
      case "tag":
        ...
        return (
          <>
            Studying tag{hasMultipleTags ? "s" : ""} <strong>{studySession.tag}</strong>.
          </>
        );
      case "random":
  ...
  const favoriteTooltip = isFavorite ? "Remove this as a favorite" : "Add this as a favorite";
      ...
      <div className="d-flex flex-column flex-grow-1 min-h-0">
        ...
        <div className="d-flex mb-3 me-3 flex-shrink-0">
          ...
          <div id="icon-list" className="d-flex align-items-center">
            ...
            >
              <FontAwesomeIcon icon={faHeart} className={`icon-hover glow ${favoriteClass}`} />
            </span>
            <FontAwesomeIcon
              icon={faPython}
        ...
        <div className="row g-0 flex-grow-1 min-h-0 mx-2">
                  ...
                  <div className="flex-grow-1">
                    <ul className="list-unstyled mb-0">
                      ...
                      <li className="d-flex">
                        ...
                        <div className="text-value">{question.needsReview ? "Yes" : "No"}</div>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="col-lg-9 ps-gutter d-flex flex-column flex-grow-1 min-h-0">
            <div className="card me-2 flex-shrink-0">
              <div ref={questionRef} id="question" className="hover-reveal-target card-body d-none">
                {/* Question - uses dangerouslySetInnerHTML for markdown */}
                <div className="d-flex">
                  <h3
                ...
                {question.isDisabled && <span className="question-disabled ms-3">Disabled</span>}
