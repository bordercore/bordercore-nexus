...
urlpatterns = [
    ...
    path("create/", views.ReminderCreateAjaxView.as_view(), name="create"),
    path("<uuid:uuid>/", views.ReminderDetailView.as_view(), name="detail"),
    path("<uuid:uuid>/edit/", views.ReminderUpdateAjaxView.as_view(), name="update"),
    path("<uuid:uuid>/delete/", views.ReminderDeleteAjaxView.as_view(), name="delete"),
]
