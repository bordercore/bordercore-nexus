...
from typing import List, Tuple  # noqa: E402 — appended after module-level imports
...
def find_similar_images(
    ...
    *,
    ...
    ``search/services.py`` (see ``build_search_object``), which scopes
    every ES query to a single owner via ``{"term": {"user_id": …}}``.
