...
for app in ("accounts", "blob", "bookmark", "collection", "drill", "feed", "fitness", "habit", "metrics", "music", "node", "reminder", "search", "tag", "todo", "visualize"):
    urlpatterns += [
...
router.register(r"fitness", FitnessViewSet, "fitness")
